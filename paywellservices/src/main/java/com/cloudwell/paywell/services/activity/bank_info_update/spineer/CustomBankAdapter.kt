 ...
 */
class CustomBankAdapter(ctx: Context, moods: List<BankDataItem>?) : ArrayAdapter<BankDataItem>(ctx, 0, moods) {
    ...
    private fun createView(position: Int, recycledView: View?, parent: ViewGroup): View {
        ...
        val view = recycledView ?: LayoutInflater.from(context).inflate(R.layout.spinner_item_layout, parent, false)
