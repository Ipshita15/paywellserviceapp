...
public class WZPDCLBillInquiryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_west_zone_inquiry);
    ...
    public void onClick(View v) {
        if (v == btnConfirm) {
            ...
            if (mBill.length() == 0) {
                etBill.setError(Html.fromHtml("<font color='red'>" + getString(R.string.consumer_or_phn_no_error_msg) + "</font>"));
            } else {
    ...
    private void submitInquiryConfirm() {
        if (!mCd.isConnectingToInternet()) {
            ...
            new SubmitInquiryAsync().execute(getString(R.string.desco_enq));
        }
    }
    ...
    private class SubmitInquiryAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(WZPDCLBillInquiryActivity.this, "", getString(R.string.loading_msg), true);
            if (!isFinishing())
                progressDialog.show();
            ...
            try {
                if (result != null) {
                    ...
                    if (status.equals("200") && Integer.parseInt(trx_no) > 0) {
                        Intent intent = new Intent(WZPDCLBillInquiryActivity.this, WZPDCLInquiryListActivity.class);
                        intent.putExtra(WZPDCLInquiryListActivity.JSON_RESPONSE, jsonObject.toString());
