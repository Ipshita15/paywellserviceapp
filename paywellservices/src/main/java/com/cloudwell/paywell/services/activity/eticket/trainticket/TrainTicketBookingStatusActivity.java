...
public class TrainTicketBookingStatusActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        ((TextView) relativeLayout.findViewById(R.id.tvPwHeader)).setTypeface(AppController.getInstance().getOxygenLightFont());
        TextView tvDate = (TextView) findViewById(R.id.tvDate);
        assert tvDate != null;
        tvDate.setTypeface(AppController.getInstance().getOxygenLightFont());
        TextView tvTime = (TextView) findViewById(R.id.tvTime);
        assert tvTime != null;
        tvTime.setTypeface(AppController.getInstance().getOxygenLightFont());
        ((TextView) relativeLayout.findViewById(R.id.tvTrainTicketHeader)).setTypeface(AppController.getInstance().getOxygenLightFont());
        TextView tvTrxId = (TextView) findViewById(R.id.tvTrxId);
        assert tvTrxId != null;
        tvTrxId.setTypeface(AppController.getInstance().getOxygenLightFont());
        TextView tvSourceStation = (TextView) findViewById(R.id.tvSourceStation);
        assert tvSourceStation != null;
        tvSourceStation.setTypeface(AppController.getInstance().getOxygenLightFont());
        TextView tvDestinationStation = (TextView) findViewById(R.id.tvDestStation);
        assert tvDestinationStation != null;
        tvDestinationStation.setTypeface(AppController.getInstance().getOxygenLightFont());
