...
public class DESCOInquiryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desco_inquiry);
    ...
    public void onClick(View v) {
        if (v == btnConfirm) {
            ...
            if (mBill.length() == 0) {
                etBill.setError(Html.fromHtml("<font color='red'>" + getString(R.string.bill_or_phn_no_error_msg) + "</font>"));
            } else {
    ...
    private class SubmitInquiryAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(DESCOInquiryActivity.this, "", getString(R.string.loading_msg), true);
            if (!isFinishing())
                progressDialog.show();
        ...
        protected String doInBackground(String... data) {
            ...
            //Log.e("resultData",data[0] + "username" + mAppHandler.getImeiNo() + "payerMobileNoOrBillNo" + mBill + "format=json");
            ...
            try {
                if (result != null) {
                    ...
                    if (status.equals("200") && Integer.parseInt(trx_no) > 0) {
                        Intent intent = new Intent(DESCOInquiryActivity.this, DESCOInquiryListActivity.class);
                        intent.putExtra(DESCOInquiryListActivity.JSON_RESPONSE, jsonObject.toString());
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DESCOInquiryActivity.this, DESCOMainActivity.class);
        startActivity(intent);
        finish();
    }
}
