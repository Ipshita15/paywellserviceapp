...
public final class CityName {
    ...
    public static final String LALMONIRhat_CITY="Lalmonirhat";
    public static final String SAIDPUR_CITY="Saidpur";
    public static final String MYMENSING_CITY="Mymensing";
    public static final String RANGPUR_CITY="Rangpur";
    public static final String THAKURGAON_CITY="Thakurgaon";
