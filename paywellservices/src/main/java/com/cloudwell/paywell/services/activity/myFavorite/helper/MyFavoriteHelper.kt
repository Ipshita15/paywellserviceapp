...
//            listOfData.add(FavoriteMenu(R.string.home_utility_dpdc, R.string.home_utility, R.drawable.ic_dpdc, MenuStatus.UnFavorite.text, 0))
            ...
            listOfData.add(FavoriteMenu(R.string.home_utility_qubee_payment_title_favoirte, R.string.home_utility, R.drawable.ic_payment_not_recived, MenuStatus.UnFavorite.text, 0))
