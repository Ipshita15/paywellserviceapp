...
public class SequenceLayout(context: Context?, attrs: AttributeSet?, defStyleAttr: Int)
    ...
    /**
     * Replaces all contained [com.transferwise.sequencelayout.SequenceStep]s with those provided and bound by the mAdapter
     */
    ...
    private fun setProgressBarHorizontalOffset() {
        val firstAnchor: View = stepsWrapper.getChildAt(0).findViewById(R.id.date)
