...
public class PassportMainActivity extends AppCompatActivity {
    ...
    boolean hasPassportService = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.home_utility_passport);
    ...
    private void initView() {
        ...
        for (int i = 0; i < serviceList.size(); i++) {
            if (PASSPORT.equalsIgnoreCase(serviceList.get(i))) {
                hasPassportService = true;
                break;
            }
        }
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(PassportMainActivity.this, UtilityMainActivity.class);
    ...
    public void onButtonClicker(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.homeBtnInquiry:
                if (hasPassportService) {
                    startActivity(new Intent(this, PassportQueryActivity.class));
                    finish();
                } else {
                    Snackbar snackbar = Snackbar.make(mRelativeLayout, R.string.services_off_msg, Snackbar.LENGTH_LONG);
                    snackbar.setActionTextColor(Color.parseColor("#ffffff"));
