...
public class RocketCashInActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        builder.setPositiveButton(R.string.okay_btn, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int id) {
                ...
                if (pinNoET.getText().toString().length() != 0) {
                    ...
                    if (cd.isConnectingToInternet()) {
                        new RocketCashInActivity.SubmitCashInDataAsync().execute(getResources().getString(R.string.rocket_cash_in),
    ...
    private class SubmitCashInDataAsync extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(RocketCashInActivity.this, "", getString(R.string.loading_msg), true);
            if (!isFinishing())
                progressDialog.show();
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                try {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(RocketCashInActivity.this);
                    ...
                    builder.setPositiveButton(R.string.okay_btn, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int id) {
                            dialogInterface.dismiss();
                            startActivity(new Intent(RocketCashInActivity.this, RocketMainActivity.class));
                        }
                    });
                    AlertDialog alert = builder.create();
                    alert.show();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(RocketCashInActivity.this, RocketMainActivity.class);
