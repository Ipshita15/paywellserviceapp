 ...
 */
public class PinEntryEditTextWithWhite extends AppCompatEditText {
    ...
    public PinEntryEditTextWithWhite(Context context) {
        super(context);
    }

    public PinEntryEditTextWithWhite(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PinEntryEditTextWithWhite(Context context, AttributeSet attrs, int defStyleAttr) {
