...
public class WASAMainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private class TransactionLogAsync extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(WASAMainActivity.this, "", getString(R.string.loading_msg), true);
            if (!isFinishing())
                progressDialog.show();
        }
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("service", "WASA"));
