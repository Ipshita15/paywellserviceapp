...
public class AppStorageBox {
    ...
    public enum Key {
        ...
        REQUEST_API_reschedule, SECURITY_TOKEN, ACCESS_KEY, TRANSPORT_ID, DEPARTURE_ID, BUS_LEAVING_FROM_CITY, BUS_JOURNEY_DATE, BUS_ID, BUS_GOING_TO_CITY, SELETED_BUS_INFO
