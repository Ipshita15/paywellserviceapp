...
public class AppStorageBox {
    ...
    public enum Key {
        ...
        REQUEST_API_reschedule, SECURITY_TOKEN, ACCESS_KEY, TRANSPORT_ID, DEPARTURE_ID, BUS_LEAVING_FROM_CITY,LAUNCH_LEAVING_FROM_CITY,LAUNCH_GOING_TO_CITY, BUS_JOURNEY_DATE,BUS_RETURN_DATE , BUS_ID, BUS_GOING_TO_CITY, SELETED_BUS_INFO, BUS_VALIDATE_DATE, BOARDING_POGISTION, USER_USED_NOTIFICAITON_FLOW, RequestScheduledata, ExtraCharge_bus
