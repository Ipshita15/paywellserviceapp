...
public class IconConstant {
    public static final String KEY_add_fav_action = "add_fav_action";
    public static final String KEY_all_operator = "all_operator";
    ...
    public static final String KEY_to_know_bill_status = "to_know_bill_status";
    public static final String KEY_ic_enquiry = "ic_enquiry";
    public static final String KEY_contact_number_change = "contact_number_change";
    public static final String KEY_ic_wasa = "ic_wasa";
    public static final String KEY_ic_west_zone = "ic_west_zone";
    public static final String KEY_ic_ivac = "ic_ivac";
    public static final String KEY_ic_banglalion = "ic_banglalion";
    public static final String KEY_ic_banglalion_recharge = "ic_banglalion_recharge";
    public static final String KEY_ic_recharge_information = "ic_recharge_information";
