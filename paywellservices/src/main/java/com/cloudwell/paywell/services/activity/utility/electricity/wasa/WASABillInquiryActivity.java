...
public class WASABillInquiryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class SubmitInquiryAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(WASABillInquiryActivity.this, "", getString(R.string.loading_msg), true);
            if (!isFinishing())
                progressDialog.show();
            ...
            try {
                if (result != null) {
                    ...
                    if (status.equals("200") && Integer.parseInt(trx_no) > 0) {
                        Intent intent = new Intent(WASABillInquiryActivity.this, WASAInquiryListActivity.class);
                        intent.putExtra(WASAInquiryListActivity.JSON_RESPONSE, jsonObject.toString());
