...
public class WZPDCLMainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private class TransactionLogAsync extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(WZPDCLMainActivity.this, "", getString(R.string.loading_msg), true);
            if (!isFinishing())
                progressDialog.show();
        }
