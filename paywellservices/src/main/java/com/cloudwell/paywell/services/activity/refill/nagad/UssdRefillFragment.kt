...
class UssdRefillFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val next6 = "কোন কারণে ব্যালেন্স যোগ না হলে পেওয়েল অ্যাপ এর ব্যালেন্স " +getFontStyle("ক্লেইম অপশন")+ " এ গিয়ে আপনার নগদ একাউন্ট নম্বর/ট্রানজেকশন আইডি ও টাকার পরিমাণ  দিয়ে ক্লেইম প্রক্রিয়া সম্পন্ন করুন।"
