...
public class ACFragment extends Fragment {
    ...
    private List<SearchBus> mBusList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new ACBusAsync(rootView, mBusList).execute(mAppHandler.getSearchBus());
        return rootView;
    }

    private class ACBusAsync extends AsyncTask<String, List<SearchBus>, List<SearchBus>> {

        private View rootView;
        private List<SearchBus> busList;

        public ACBusAsync(View rootView, List<SearchBus> busList) {
                    ...
                    if (status.equals("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (Integer.valueOf(_availableSeat) > 0) {
                                ...
                                if (_coachType.equalsIgnoreCase("Ac")) {
    ...
    private RecyclerItemClickListener.OnItemClickListener listener = new RecyclerItemClickListener.OnItemClickListener() {
        ...
        public void onItemClicked(View view, int position) {
            ...
            intent.putExtra(SeatListActivity.FRAGMENT_KEY, SeatListActivity.AC);
