...
public class DPDCBillPayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initializeView() {
        ...
        etLocation = (EditText) findViewById(R.id.mycash_location);
        etPin = (EditText) findViewById(R.id.pin_no);
        ivInfoBill = (ImageView) findViewById(R.id.imageView_infoBill);
        ivInfoLocation = (ImageView) findViewById(R.id.imageView_infoLocation);
    ...
    private void submitInquiryConfirm() {
        if (!mCd.isConnectingToInternet()) {
            ...
            new SubmitInquiryAsync().execute(getString(R.string.dpdc_bill_enq));
        }
    }
    ...
    private class SubmitInquiryAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(DPDCBillPayActivity.this, "", getString(R.string.loading_msg), true);
            if (!isFinishing())
                progressDialog.show();
        }
                ...
                if (result != null) {
                    ...
                    if (status.equals("200")) {
                        ...
                        if (!mTotalAmount.equals("0")) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(DPDCBillPayActivity.this);
    ...
    private void submitBillConfirm() {
        if (!mCd.isConnectingToInternet()) {
            ...
            new SubmitBillAsync().execute(getString(R.string.dpdc_bill_pay));
        }
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DPDCBillPayActivity.this, DPDCMainActivity.class);
