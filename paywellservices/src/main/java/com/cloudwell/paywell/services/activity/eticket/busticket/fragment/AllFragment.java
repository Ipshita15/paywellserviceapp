...
public class AllFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new AllBusAsync(rootView, mBusList).execute(mAppHandler.getSearchBus());
        return rootView;
    }

    private class AllBusAsync extends AsyncTask<String, List<SearchBus>, List<SearchBus>> {

        private View rootView;
        private List<SearchBus> busList;

        public AllBusAsync(View rootView, List<SearchBus> busList) {
        ...
        @Override
        protected void onPostExecute(List<SearchBus> busList) {
            if (busList.size() != 0) {
    ...
    private RecyclerItemClickListener.OnItemClickListener listener = new RecyclerItemClickListener.OnItemClickListener() {
        ...
        public void onItemClicked(View view, int position) {
            ...
            intent.putExtra(SeatListActivity.FRAGMENT_KEY, SeatListActivity.ALL);
